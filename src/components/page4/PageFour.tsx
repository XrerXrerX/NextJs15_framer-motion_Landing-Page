  ...
  return (
    <div className="relative flex justify-center items-center h-screen overflow-hidden 2xl:mt-12 xl:mt-12 lg:mt-12 md:mt-12 sm:mt-2 xs:mt-12">
          ...
          return (
            ...
            >
              ...
              <img
                ...
                style={{
                  transform: `rotate(${angle}deg) translate(${
                    (150 + i * 150) / 2
                  }px) rotate(${-angle}deg)`, // Cancels the rotation effect
                }}
              />
              ...
              <img
                ...
                className="w-12 h-12 rounded-full absolute"
                style={{
                  transform: `rotate(${angle + 180}deg) translate(${
                    (150 + i * 150) / 2
                  }px) rotate(${-angle + 180}deg)`, // Cancels the rotation effect
                }}
              />
            </motion.div>
          );
      ...
      <div className="relative z-10 flex flex-col items-center text-center p-6 bg-transparent rounded-lg shadow-lg max-w-lg">
        ...
        <p className="2xl:text-3xl xl:text-2xl lg:text-2xl md:text-2xl sm:text-2xl font-semibold text-slate-200 xs:text-2xl">
        ...
        <p className="text-slate-200 mb-1 2xl:text-sm xl:text-sm lg:text-sm md:text-xs xs:text-xs sm:text-sm">
          Di era digital saat ini, konsumen lebih sering mencari produk dan jasa
          melalui internet. Bisnis yang memiliki website akan lebih mudah
          ditemukan dan dipercaya oleh pelanggan, karena website berfungsi
          seperti toko atau kantor online yang selalu siap melayani selama 24
          jam tanpa henti. Dengan website, bisnis Anda selalu terbuka dan siap
          menyambut peluang kapan saja
        </p>
